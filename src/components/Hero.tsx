...
const Hero = () => (
  <section className="relative min-h-screen flex flex-col justify-center pt-20 overflow-hidden bg-background">
    <AnimatedBlockchainBg opacity={0.10} color="green" />
    <div className="absolute inset-0 opacity-[0.03]">
      <img src={riceFields} alt="" className="w-full h-full object-cover" />
    </div>
    <div className="absolute top-20 right-0 w-[600px] h-[600px] rounded-full bg-[hsl(140,55%,90%)] blur-[120px] opacity-40" />
    <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-[hsl(164,60%,92%)] blur-[100px] opacity-30" />
    <div className="absolute top-1/2 left-1/3 w-[300px] h-[300px] rounded-full bg-[hsl(100,40%,92%)] blur-[80px] opacity-20" />
        ...
        <div>
          ...
          <ScrollReveal delay={0.24}>
            <div className="flex flex-wrap gap-4">
              <a href="#infrastructure" className="inline-flex items-center px-7 py-3.5 rounded-lg bg-teal-DEFAULT text-white font-sans font-medium text-sm hover:opacity-90 transition-opacity active:scale-[0.97]">
                Explore the Infrastructure
              </a>
              <a href="#contact" className="inline-flex items-center px-7 py-3.5 rounded-lg border border-border text-foreground font-sans font-medium text-sm hover:bg-muted transition-colors active:scale-[0.97]">
                Contact Us
              </a>
            </div>
          </ScrollReveal>
