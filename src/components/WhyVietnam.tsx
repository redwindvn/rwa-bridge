  ...
  <section id="vietnam" className="py-24 md:py-32 relative overflow-hidden bg-background">
    ...
    <div className="container mx-auto relative z-10">
      ...
      <ScrollReveal delay={0.3}>
        <div className="mt-14 p-6 rounded-xl bg-[hsl(var(--green-light))] border border-[hsl(var(--green-accent))]/10 text-center max-w-3xl mx-auto">
          <p className="text-body-lg font-sans text-foreground leading-relaxed">
            Three forces converging for the first time: real commodities at global scale, a digital-ready market, and a purpose-built regulatory framework.
          </p>
        </div>
      </ScrollReveal>
    </div>
